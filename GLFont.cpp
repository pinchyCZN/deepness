...
GLFont::GLFont(HDC hDC, const char *s, float thickness) {
...
float GLFont::printChar(char c, float lsx, float lsy, float lr, float tracking) const {
  c -= 32;
